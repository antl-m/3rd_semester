...
BOOST_AUTO_TEST_SUITE(MatrixGraphTest);

    BOOST_AUTO_TEST_CASE (pushing_vertex_test) {
        MatrixGraph<std::string, double> g;
        MatrixStruct<std::string, double> exp;
    ...
    BOOST_AUTO_TEST_CASE (pushing_edge_test) {
        ...
        exp["Yuzhne"]["Odessa"] = 45.7;
        exp["Odessa"]["Yuzhne"] = 45.7;
    ...
    BOOST_AUTO_TEST_CASE(length__not_ariphmetic_test) {
        MatrixGraph<std::string, std::string> g;
        g.push_vertex("Yuzhne");
        g.push_vertex("Odessa");
